...
/**
 * @author inkelink
 * @Description: 路由发布缓存记录实体
 * @date 2023年08月24日
 * @变更说明 BY inkelink At 2023年08月24日
 */
@Data
@EqualsAndHashCode(callSuper = true)
@Schema(description = "路由发布缓存记录")
@TableName("PRC_RC_SML_ROUTE_PUBLISH_LOG")
public class RcSmlRoutePublishLogEntity extends BaseEntity {

    /**
     *
     */
    @Schema(title = "")
    @TableId(value = "PRC_RC_SML_ROUTE_PUBLISH_LOG_ID", type = IdType.INPUT)
