...
@TableName("PRC_RC_PS_ROUTE_PUBLISH_LOG")
public class RcPsRoutePublishLogEntity extends BaseEntity {

    /**
     *
     */
    @Schema(title = "主键")
    @TableId(value = "PRC_RC_PS_ROUTE_PUBLISH_LOG_ID", type = IdType.INPUT)
