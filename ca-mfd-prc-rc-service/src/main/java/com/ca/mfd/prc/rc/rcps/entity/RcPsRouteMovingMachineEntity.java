...
@TableName("PRC_RC_PS_ROUTE_MOVING_MACHINE")
public class RcPsRouteMovingMachineEntity extends BaseEntity {

    /**
     *
     */
    @Schema(title = "主键")
    @TableId(value = "PRC_RC_PS_ROUTE_MOVING_MACHINE_ID", type = IdType.INPUT)
