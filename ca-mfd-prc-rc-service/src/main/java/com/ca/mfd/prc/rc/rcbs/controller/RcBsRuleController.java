 ...
 */
@RestController
@RequestMapping("rcbsrule")
@Tag(name = "路由规则服务", description = "路由规则")
public class RcBsRuleController extends BaseController<RcBsRuleEntity> {

    private final IRcBsRuleService rcRuleService;

    @Autowired
    public RcBsRuleController(IRcBsRuleService rcRuleService) {
