...
@TableName("PRC_RC_PS_POLICY_RULE")
public class RcPsPolicyRuleEntity extends BaseEntity {

    /**
     * 主键
     */
    @Schema(title = "主键")
    @TableId(value = "PRC_RC_PS_POLICY_RULE_ID", type = IdType.INPUT)
     ...
     */
    @Schema(title = "策略ID")
    @TableField("PRC_RC_PS_POLICY_ID")
    @JsonSerialize(using = ToStringSerializer.class)
    @JsonDeserialize(using = JsonDeserializeLong.class)
    @JsonProperty("policyId")
    @JsonAlias(value = {"policyId", "PolicyId"})
    private Long prcRcPsPolicyId = Constant.DEFAULT_ID;
     ...
     */
    @Schema(title = "路由规则ID")
    @TableField("PRC_RC_PS_RULE_ID")
    @JsonSerialize(using = ToStringSerializer.class)
    @JsonDeserialize(using = JsonDeserializeLong.class)
    @JsonProperty("ruleId")
    @JsonAlias(value = {"ruleId", "RuleId"})
    private Long prcRcPsRuleId = Constant.DEFAULT_ID;
