...
@TableName("PRC_RC_PS_ROUTE_AREA_ATTACH")
public class RcPsRouteAreaAttachEntity extends BaseEntity {

    /**
     *
     */
    @Schema(title = "主键")
    @TableId(value = "PRC_RC_PS_ROUTE_AREA_ATTACH_ID", type = IdType.INPUT)
