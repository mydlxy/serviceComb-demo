...
@TableName("PRC_BDC_ROUTE_AREA_ATTACH")
public class RcBdcRouteAreaAttachEntity extends BaseEntity {

    /**
     *
     */
    @Schema(title = "")
    @TableId(value = "PRC_BDC_ROUTE_AREA_ATTACH_ID", type = IdType.INPUT)
