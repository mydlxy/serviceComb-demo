...
@TableName("PRC_RC_AVI_ROUTE_POINT_LOG")
public class RcAviRoutePointLogEntity extends BaseEntity {

    /**
     *
     */
    @Schema(title = "主键")
    @TableId(value = "PRC_RC_AVI_ROUTE_POINT_LOG_ID", type = IdType.INPUT)
