...
import com.ca.mfd.prc.rc.rcbs.dto.RcRouteHoldDTO;
 ...
 */
@RestController
@RequestMapping("rcbsroutehold")
@Tag(name = "路由区暂存表服务", description = "路由区暂存表")
public class RcBsRouteHoldController extends BaseController<RcBsRouteHoldEntity> {

    private final IRcBsRouteHoldService rcRouteHoldService;

    @Autowired
    public RcBsRouteHoldController(IRcBsRouteHoldService rcRouteHoldService) {
