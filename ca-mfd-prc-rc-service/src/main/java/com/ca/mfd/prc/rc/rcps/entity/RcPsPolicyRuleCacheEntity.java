...
@TableName("PRC_RC_PS_POLICY_RULE_CACHE")
public class RcPsPolicyRuleCacheEntity extends BaseEntity {

    /**
     * 主键
     */
    @Schema(title = "主键")
    @TableId(value = "PRC_RC_PS_POLICY_RULE_CACHE_ID", type = IdType.INPUT)
     ...
     */
    @Schema(title = "路由点 ID")
    @TableField("PRC_RC_PS_ROUTE_POINT_ID")
    @JsonSerialize(using = ToStringSerializer.class)
    @JsonDeserialize(using = JsonDeserializeLong.class)
    @JsonProperty("pointId")
    @JsonAlias(value = {"pointId", "PointId"})
    private Long prcRcPsRoutePointId = Constant.DEFAULT_ID;
     ...
     */
    @Schema(title = "策略明细ID")
    @TableField("PRC_RC_PS_POLICY_RULE_ID")
    @JsonSerialize(using = ToStringSerializer.class)
    @JsonDeserialize(using = JsonDeserializeLong.class)
    @JsonProperty("ruleId")
    @JsonAlias(value = {"ruleId", "RuleId"})
    private Long prcRcPsPolicyRuleId = Constant.DEFAULT_ID;
