...
@TableName("PRC_RC_BS_ROUTE_PUBLISH_LOG")
public class RcBsRoutePublishLogEntity extends BaseEntity {

    /**
     *
     */
    @Schema(title = "主键")
    @TableId(value = "PRC_RC_BS_ROUTE_PUBLISH_LOG_ID", type = IdType.INPUT)
