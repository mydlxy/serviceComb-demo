...
@TableName("PRC_RC_SML_ROUTE_CACHE_LOG")
public class RcSmlRouteCacheLogEntity extends BaseEntity {

    /**
     *
     */
    @Schema(title = "")
    @TableId(value = "PRC_RC_SML_ROUTE_CACHE_LOG_ID", type = IdType.INPUT)
