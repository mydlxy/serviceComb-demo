...
@TableName("PRC_RC_AVI_ROUTE_AREA_ATTACH")
public class RcAviRouteAreaAttachEntity extends BaseEntity {
    /**
     *
     */
    @Schema(title = "主键")
    @TableId(value = "PRC_RC_AVI_ROUTE_AREA_ATTACH_ID", type = IdType.INPUT)
