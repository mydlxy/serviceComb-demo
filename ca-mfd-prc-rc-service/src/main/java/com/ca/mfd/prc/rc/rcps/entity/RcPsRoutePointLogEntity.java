...
@TableName("PRC_RC_PS_ROUTE_POINT_LOG")
public class RcPsRoutePointLogEntity extends BaseEntity {

    /**
     *
     */
    @Schema(title = "主键")
    @TableId(value = "PRC_RC_PS_ROUTE_POINT_LOG_ID", type = IdType.INPUT)
