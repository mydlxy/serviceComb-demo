...
@TableName("PRC_RC_BS_POLICY_RULE")
public class RcBsPolicyRuleEntity extends BaseEntity {

    /**
     * 主键
     */
    @Schema(title = "主键")
    @TableId(value = "PRC_RC_BS_POLICY_RULE_ID", type = IdType.INPUT)
     ...
     */
    @Schema(title = "路由规则ID")
    @TableField("PRC_RC_BS_RULE_ID")
    @JsonSerialize(using = ToStringSerializer.class)
    @JsonDeserialize(using = JsonDeserializeLong.class)
    @JsonProperty("ruleId")
    @JsonAlias(value = {"ruleId", "RuleId"})
    private Long prcRcBsRuleId = Constant.DEFAULT_ID;
