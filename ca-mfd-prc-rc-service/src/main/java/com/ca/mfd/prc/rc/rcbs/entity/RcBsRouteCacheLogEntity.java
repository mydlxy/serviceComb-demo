...
@TableName("PRC_RC_BS_ROUTE_CACHE_LOG")
public class RcBsRouteCacheLogEntity extends BaseEntity {

    /**
     * 主键
     */
    @Schema(title = "主键")
    @TableId(value = "PRC_RC_BS_ROUTE_CACHE_LOG_ID", type = IdType.INPUT)
     ...
     */
    @Schema(title = "车道外键")
    @TableField("PRC_RC_BS_ROUTE_LANE_ID")
    @JsonSerialize(using = ToStringSerializer.class)
    @JsonDeserialize(using = JsonDeserializeLong.class)
    @JsonProperty("LaneId")
    @JsonAlias(value = {"laneId", "LaneId"})
    private Long prcRcBsRouteLaneId = Constant.DEFAULT_ID;
