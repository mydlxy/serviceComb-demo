...
@TableName("PRC_RC_BS_ROUTE_POINT_LOG")
public class RcBsRoutePointLogEntity extends BaseEntity {

    /**
     *
     */
    @Schema(title = "主键")
    @TableId(value = "PRC_RC_BS_ROUTE_POINT_LOG_ID", type = IdType.INPUT)
