...
/**
 * @author inkelink
 * @Description: 路由区HOLD车实体
 * @date 2023年08月24日
 * @变更说明 BY inkelink At 2023年08月24日
 */
@Data
@EqualsAndHashCode(callSuper = true)
@Schema(description = "路由区HOLD车")
@TableName("PRC_RC_SML_ROUTE_HOLD")
public class RcSmlRouteHoldEntity extends BaseEntity {

    /**
     *
     */
    @Schema(title = "")
    @TableId(value = "PRC_RC_SML_ROUTE_HOLD_ID", type = IdType.INPUT)
