...
@Schema(description = "AGV监听")
@TableName("PRC_EPS_AGV_MONITORING")
public class EpsAgvMonitoringEntity extends BaseEntity {

    @Schema(title = "主键")
    @TableId(value = "PRC_EPS_AGV_MONITORING_ID", type = IdType.INPUT)
