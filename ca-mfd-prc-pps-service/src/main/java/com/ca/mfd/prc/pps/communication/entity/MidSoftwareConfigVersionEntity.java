...
@Schema(description= "配置字版本")
@TableName("PRC_MID_SOFTWARE_CONFIG_VERSION")
public class MidSoftwareConfigVersionEntity extends BaseEntity {

    /**
     * 主键
     */
    @Schema(title = "主键")
    @TableId(value = "PRC_MID_SOFTWARE_CONFIG_VERSION_ID", type = IdType.INPUT)
