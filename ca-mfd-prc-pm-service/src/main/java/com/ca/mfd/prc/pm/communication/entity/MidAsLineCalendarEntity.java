...
/**
 * @author inkelink
 * @Description: AS线体日历中间表实体
 * @date 2023年10月19日
 * @变更说明 BY inkelink At 2023年10月19日
 */
@Data
@EqualsAndHashCode(callSuper = true)
@Schema(description = "AS线体日历中间表")
@TableName("PRC_MID_AS_LINE_CALENDAR")
public class MidAsLineCalendarEntity extends BaseEntity {

    /**
     * 主键
     */
    @Schema(title = "主键")
    @TableId(value = "PRC_MID_AS_LINE_CALENDAR_ID", type = IdType.INPUT)
