...
/**
 * @author inkelink
 * @Description: AUDIT缺陷等级配置实体
 * @date 2023年08月22日
 * @变更说明 BY inkelink At 2023年08月22日
 */
@Data
@EqualsAndHashCode(callSuper = false, of = "gradeCode")
@Schema(description = "AUDIT缺陷等级配置")
@TableName("PRC_PQS_AUDIT_GRADE")
public class PqsAuditGradeEntity extends BaseEntity {

    /**
     * 主键
     */
    @Schema(title = "主键")
    @TableId(value = "PRC_PQS_AUDIT_GRADE_ID", type = IdType.INPUT)
