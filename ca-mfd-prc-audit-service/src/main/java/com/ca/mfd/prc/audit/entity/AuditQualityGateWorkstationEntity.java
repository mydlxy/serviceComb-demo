...
/**
 *
 * @Description: AUDIT QG检查项关联的岗位实体
 * @author inkelink
 * @date 2023年12月04日
...
@Schema(description= "AUDIT QG检查项关联的岗位")
@TableName("PRC_AUDIT_QUALITY_GATE_WORKSTATION")
public class AuditQualityGateWorkstationEntity extends BaseEntity {

    /**
     * 主键
     */
    @Schema(title = "主键")
    @TableId(value = "PRC_AUDIT_QUALITY_GATE_WORKSTATION_ID", type = IdType.INPUT)
