...
@Schema(description= "AUDIT QG检查项-车型")
@TableName("PRC_AUDIT_QUALITY_GATE_TC")
public class AuditQualityGateTcEntity extends BaseEntity {

    /**
     * 主键
     */
    @Schema(title = "主键")
    @TableId(value = "PRC_AUDIT_QUALITY_GATE_TC_ID", type = IdType.INPUT)
