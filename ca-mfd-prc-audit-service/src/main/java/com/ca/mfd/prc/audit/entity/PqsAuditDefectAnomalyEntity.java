...
@TableName("PRC_PQS_AUDIT_DEFECT_ANOMALY")
public class PqsAuditDefectAnomalyEntity extends BaseEntity {

    /**
     * 主键
     */
    @Schema(title = "主键")
    @TableId(value = "PRC_PQS_AUDIT_DEFECT_ANOMALY_ID", type = IdType.INPUT)
    ...
    private String defectName = StringUtils.EMPTY;
