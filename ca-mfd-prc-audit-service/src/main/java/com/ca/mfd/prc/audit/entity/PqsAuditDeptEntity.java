...
/**
 * @author inkelink
 * @Description: AUDIT责任部门配置实体
 * @date 2023年08月22日
 * @变更说明 BY inkelink At 2023年08月22日
 */
@Data
@EqualsAndHashCode(callSuper = false, of = "deptCode")
@Schema(description = "AUDIT责任部门配置")
@TableName("PRC_PQS_AUDIT_DEPT")
public class PqsAuditDeptEntity extends BaseEntity {

    /**
     * 主键
     */
    @Schema(title = "主键")
    @TableId(value = "PRC_PQS_AUDIT_DEPT_ID", type = IdType.INPUT)
