...
@Schema(description= "过点信息下发记录")
@TableName("PRC_MID_DJ_SITE_SEND")
public class MidDjSiteSendEntity extends BaseEntity {

    /**
     * 主键
     */
    @Schema(title = "主键")
    @TableId(value = "PRC_MID_DJ_SITE_SEND_ID", type = IdType.INPUT)
