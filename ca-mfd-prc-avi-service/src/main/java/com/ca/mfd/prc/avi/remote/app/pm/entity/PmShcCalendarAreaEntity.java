...
/**
 * @author inkelink
 * @Description: 工厂日历-线体实体
 * @date 2023年08月28日
 * @变更说明 BY inkelink At 2023年08月28日
 */
@Data
@EqualsAndHashCode(callSuper = true)
@Schema(description = "工厂日历-线体")
@TableName("PRC_PM_SHC_CALENDAR_AREA")
public class PmShcCalendarAreaEntity extends BaseEntity {

    /**
     *
     */
    @Schema(title = "")
    @TableId(value = "PRC_PM_SHC_CALENDAR_AREA_ID", type = IdType.INPUT)
