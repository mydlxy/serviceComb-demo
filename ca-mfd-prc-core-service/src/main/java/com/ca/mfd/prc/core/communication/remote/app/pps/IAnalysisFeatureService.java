...
import com.ca.mfd.prc.core.communication.remote.app.pps.dto.FilterFetureExpressionPara;
 ...
 */
@FeignClient(name = "ca-mfd-prc-pps-service", path = "analysisfeture", contextId = "inkelink-pps-analysisfeture")
