...
@Schema(description= "班次中间表")
@TableName("PRC_MID_PM_SHIFT")
public class MidPmShiftEntity extends BaseEntity {

    /**
     * 主键
     */
    @Schema(title = "主键")
    @TableId(value = "PRC_MID_PM_SHIFT_ID", type = IdType.INPUT)
