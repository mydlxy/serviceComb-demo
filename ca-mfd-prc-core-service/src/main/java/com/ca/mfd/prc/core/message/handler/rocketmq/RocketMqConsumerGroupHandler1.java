...
@RocketMQMessageListener(topic = ""
        , consumerGroup = "${inkelink.core.mq.rocketmq.consumer.groupDefault}"
...
public class RocketMqConsumerGroupHandler1 extends BaseRocketMqConsumerGroupHandler implements RocketMQListener<String>, RocketMQPushConsumerLifecycleListener {
