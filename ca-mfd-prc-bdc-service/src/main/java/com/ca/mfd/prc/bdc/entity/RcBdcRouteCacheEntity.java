...
@TableName("PRC_BDC_ROUTE_CACHE")
public class RcBdcRouteCacheEntity extends BaseEntity {

    /**
     * 主键
     */
    @Schema(title = "主键")
    @TableId(value = "PRC_BDC_ROUTE_CACHE_ID", type = IdType.INPUT)
     ...
     * 车辆类型:10-白车身;20-彩车身;
     */
    @Schema(title = "车辆类型:10-白车身;20-彩车身;")
    @TableField("SN_TYPE")
     ...
     * 是否在出库队列
     */
    @Schema(title = "是否在出库队列")
    @TableField("IS_QUEUED")
