...
@TableName("PRC_BDC_ROUTE_PUBLISH_LOG")
public class RcBdcRoutePublishLogEntity extends BaseEntity {

    /**
     * 主键
     */
    @Schema(title = "主键")
    @TableId(value = "PRC_BDC_ROUTE_PUBLISH_LOG_ID", type = IdType.INPUT)
