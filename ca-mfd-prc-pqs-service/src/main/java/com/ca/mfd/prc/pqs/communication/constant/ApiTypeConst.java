package com.ca.mfd.prc.pqs.communication.constant;
...
public interface ApiTypeConst {
    ...
    // QMS 质量管理-缺陷库
    public static final String PMS_ICC_DATA = "MOM-QMS-01";
    // QMS 质量管理-缺陷等级
    public static final String PMS_ICC_CATEGORY = "MOM-QMS-02";

    // QMS 质量管理-产品缺陷数据
    public static final String PMS_PRODUCT_DEFECT_ANOMALY = "MOM-QMS-04";


    //主数据 国家
    public static final String MAIN_COUNTRY = "MOM-MDM-01";
    //主数据 班次
    public static final String MAIN_SHIFT = "MOM-MAIN-02";
}
