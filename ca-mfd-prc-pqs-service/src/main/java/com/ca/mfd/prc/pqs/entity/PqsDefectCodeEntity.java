 ...
 */
@Data
@EqualsAndHashCode(callSuper = false, of = "defectCodeCode")
@Schema(description = "缺陷代码")
@TableName("PRC_PQS_DEFECT_CODE")
public class PqsDefectCodeEntity extends BaseEntity {

    /**
     * 主键
     */
    @Schema(title = "主键")
    @TableId(value = "PRC_PQS_DEFECT_CODE_ID", type = IdType.INPUT)
