 ...
 */
@Data
@EqualsAndHashCode(callSuper = false, of = "defectComponentCode")
@Schema(description = "组件代码")
@TableName("PRC_PQS_DEFECT_COMPONENT")
public class PqsDefectComponentEntity extends BaseEntity {

    /**
     * 主键
     */
    @Schema(title = "主键")
    @TableId(value = "PRC_PQS_DEFECT_COMPONENT_ID", type = IdType.INPUT)
