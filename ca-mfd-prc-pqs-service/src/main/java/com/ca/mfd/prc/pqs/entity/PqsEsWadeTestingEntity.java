...
@Schema(description= "涉水测试")
@TableName("PRC_PQS_ES_WADE_TESTING")
public class PqsEsWadeTestingEntity extends BaseEntity {

    /**
     * ID
     */
    @Schema(title = "ID")
    @TableId(value = "PRC_PQS_ES_WADE_TESTING_ID", type = IdType.INPUT)
