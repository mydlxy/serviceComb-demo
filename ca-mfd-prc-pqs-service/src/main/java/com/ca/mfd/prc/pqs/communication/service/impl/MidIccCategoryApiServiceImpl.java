...
import com.ca.mfd.prc.pqs.communication.mapper.IMidIccCategoryApiMapper;
...
public class MidIccCategoryApiServiceImpl extends AbstractCrudServiceImpl<IMidIccCategoryApiMapper, MidIccCategoryApiEntity> implements IMidIccCategoryApiService {
    ...
    @Override
    public List<MidIccCategoryApiEntity> getListByLog(Long id) {
        QueryWrapper<MidIccCategoryApiEntity> qry = new QueryWrapper<>();
        qry.lambda().eq(MidIccCategoryApiEntity::getPrcMidApiLogId, id);
