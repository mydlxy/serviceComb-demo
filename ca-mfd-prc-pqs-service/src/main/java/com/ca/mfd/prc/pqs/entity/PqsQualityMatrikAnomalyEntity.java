...
/**
 * @author inkelink
 * @Description: 百格图-缺陷实体
 * @date 2023年08月22日
 * @变更说明 BY inkelink At 2023年08月22日
 */
@Data
@EqualsAndHashCode(callSuper = true)
@Schema(description = "百格图-缺陷")
@TableName("PRC_PQS_QUALITY_MATRIK_ANOMALY")
public class PqsQualityMatrikAnomalyEntity extends BaseEntity {

    /**
     * 主键
     */
    @Schema(title = "主键")
    @TableId(value = "PRC_PQS_QUALITY_MATRIK_ANOMALY_ID", type = IdType.INPUT)
