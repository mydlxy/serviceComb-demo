...
public interface IPmVersionService {
    ...
    ResultVO<List<String>> getRelevanceQgWorkplaceByStationId(@RequestParam("stationId") String stationId);
    ...
    ResultVO<List<PmWorkStationEntity>> getrelevanceworkplacebystation(@RequestParam("workstationCode") String workstationCode);
